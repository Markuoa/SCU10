...
if __name__ == '__main__':
    UserInfo.objects.create(Username='麻阔', password='123456', Email='765019392@qq.com')
    q = UserInfo.objects.filter(Username='麻阔')
    newImg = str(q[0].UserID) + '.jpg'
    q.update(Img=newImg)

    Goods.objects.create(Price=25, Contact_QQ=765019392, Note='无', UserID=q[0], Commodity_Name='高等数学')
    q = Goods.objects.filter(Commodity_Name='高等数学')

    UserInfo.objects.create(Username='刘忠东', password='123456', Email='2328954508@qq.com')
